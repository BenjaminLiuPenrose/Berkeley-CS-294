...
class ModelBasedRL(object):
    ...
    def __init__(self,
                 ...
                 render=False,
                 mpc_horizon=15, # var 1
                 num_random_action_selection=4096, # var 2
                 nn_layers=1): # var 3
        self._env = env
    ...
    def run_q1(self):
        ...
        for r_num, (states, actions, _, _, _) in enumerate(self._random_dataset.rollout_iterator()):
            ...
            for i in range(actions.shape[0]):
                next_state = self._policy.predict(next_state, actions[i])
    ...
    def run_q3(self):
        ...
        for itr in range(self._num_onpolicy_iters + 1):
            ...
            # raise NotImplementedError
            ### BEGIN Solution
            rollout = self._gather_rollouts(self._policy, self._num_onpolicy_rollouts)
            ### END Solution
